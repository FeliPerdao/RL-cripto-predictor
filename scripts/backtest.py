...
def backtest(data, model_path, steps=3, n_tests=100, verbose=False):
    ...
    max_start = len(env.data) - steps
    positions = random.sample(range(10, max_start), min(n_tests, max_start - 10))
    ...
    for pos in positions:
        ...
        try:
            ...
            true_returns = env.data.iloc[pos:pos + steps]["return"].values
            ...
            print(f"⚠️ Salteando posición {pos} por error: {e}")
